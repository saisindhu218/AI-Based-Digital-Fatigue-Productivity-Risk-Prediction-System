...
class MLService:
    ...
    def load_models(self):
        ...
        try:
            ...
            classifier=models_dir/"fatigue_classifier.pkl"
            encoder=models_dir/"fatigue_label_encoder.pkl"
            productivity=models_dir/"productivity_loss_model.pkl"
            ...
            if self.is_loaded:
                ...
                print("Using behavioral prediction fallback")
        ...
        try:
            ...
            if self.is_loaded:
                ...
                if hasattr(self.fatigue_classifier,"predict_proba"):
                    confidence=float(max(self.fatigue_classifier.predict_proba(X)[0]))
                else:
                    confidence=0.85
    ...
    def predict_productivity_loss(self,features:dict):
        ...
        try:
            ...
            screen=features.get("screen_time",0)
            fatigue=features.get("fatigue_index",50)
            ...
            if self.is_loaded:
                ...
                fatigue_result=self.predict_fatigue(features)
            ...
            print("Productivity prediction error:",e)
